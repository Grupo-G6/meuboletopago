...
@Composable
fun Tela(modifier: Modifier, cardInfo: List<CardInfo> /*TODO:, navController: NavController, ctx: Context*/){

    LazyColumn{
        itemsIndexed(cardInfo){
                index, item ->  meuCard(cardInfo[index]/*TODO:, navController, ctx*/)
        }
    }
...
@Composable
fun meuCard(cardInfo: CardInfo/*TODO:, navController: NavController, ctx: Context*/){
    ...
    Column(
        ...
        Card(
            ...
            modifier = Modifier
                .clickable(onClick = {/*TODO: navController.navigate("detail_page") */ })
